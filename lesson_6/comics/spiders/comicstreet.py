...
class ComicstreetSpider(scrapy.Spider):
    ...
    def __init__(self, mark):
        self.start_urls = [f'https://www.comicstreet.ru/search?page=1&q={mark}']
    ...
    def parse_ads(self, response: HtmlResponse):
        ...
        loader.add_xpath('char', "//div[@class='product-properties']//dd/text()|//div[@class='product-properties']//dd//span/text()|//div[@class='product-properties']//dd//a/text()")
